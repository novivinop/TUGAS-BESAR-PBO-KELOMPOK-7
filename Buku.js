...
function inputDataPeminjaman() {
    ...
    let dataMhs = new Peminjaman(nama,nim,prodiKalimat,kodeBuku,judulBukuPeminjaman,tglPeminjaman, tglKembali)
    arrayMhs.push(dataMhs)
}

function cetakDataPeminjam(){
    for(var p = 0; p < arrayMhs.length; p++) {
...
while(pilihMenuAll){
    console.log("======================")
    console.log("  PERPUSTAKAAN APAYA  ")
    console.log("======================")
